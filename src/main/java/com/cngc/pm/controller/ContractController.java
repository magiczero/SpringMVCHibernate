...
public class ContractController {
	...
	public String save(@Valid @ModelAttribute("contract") Contract contract, HttpServletRequest request,Authentication authentication){
		
		contract.setCreatedUser(userUtil.getUserId(authentication));
