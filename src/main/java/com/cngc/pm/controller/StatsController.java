...
public class StatsController {
	...
	public String incident(Model model,HttpServletRequest request){
		...
		if(columnCategory!=null)
			model.addAttribute("stat", incidentService.getStats(columnCategory, rowCategory,startTime,endTime,status));
	...
	public String incidentCount(Model model,HttpServletRequest request){
		...
		model.addAttribute("stat", incidentService.getStats("DATE_MONTH", null,startTime,endTime,PropertyFileUtil.getStringValue("syscode.incident.status.finished")));
	...
	public String incidentCategory(Model model,HttpServletRequest request){
		...
		model.addAttribute("stat", incidentService.getStats("DATE_MONTH", "CODE_CATEGORY",startTime,endTime,PropertyFileUtil.getStringValue("syscode.incident.status.finished")));
	...
	public String incidentPerformance(Model model,HttpServletRequest request){
		...
		model.addAttribute("stat", incidentService.getStats("DATE_MONTH", "USER_ENGINEER",startTime,endTime,PropertyFileUtil.getStringValue("syscode.incident.status.finished")));
	...
	public String incidentSatisfaction(Model model,HttpServletRequest request){
		...
		model.addAttribute("stat", incidentService.getStats("DATE_MONTH", "CODE_SATISFACTION",startTime,endTime,PropertyFileUtil.getStringValue("syscode.incident.status.finished")));
	...
	public String incidentCi(Model model,HttpServletRequest request){
		...
		model.addAttribute("stat", incidentService.getStats("DATE_MONTH", "CI_ASSET",startTime,endTime,PropertyFileUtil.getStringValue("syscode.incident.status.finished")));
	...
	public String changeCount(Model model,HttpServletRequest request){
		...
		model.addAttribute("stat", changeService.getStats("DATE_MONTH", null,startTime,endTime,PropertyFileUtil.getStringValue("syscode.change.status.finished")));
	...
	public String changeRisk(Model model,HttpServletRequest request){
		...
		model.addAttribute("stat", changeService.getStats("DATE_MONTH", "CODE_RISK",startTime,endTime,PropertyFileUtil.getStringValue("syscode.change.status.finished")));
	...
	public String changePerformance(Model model,HttpServletRequest request){
		...
		model.addAttribute("stat", changeService.getStats("DATE_MONTH", "USER_ENGINEER",startTime,endTime,PropertyFileUtil.getStringValue("syscode.change.status.finished")));
	...
	public String cmsCount(Model model,HttpServletRequest request){
		...
		model.addAttribute("stat", ciService.getStats("CODE_STATUS", null,null));
	...
	public String cmsCategory(Model model,HttpServletRequest request){
		...
		model.addAttribute("stat", ciService.getStats("CODE_STATUS", "CODE_CATEGORY",null));
	...
	public String cmsPerformance(Model model,HttpServletRequest request){
		...
		model.addAttribute("stat", ciService.getStats("CODE_STATUS", "USER_ENGINEER",null));
	...
	public String knowledge(Model model,HttpServletRequest request){
		...
		if(columnCategory!=null)
			model.addAttribute("stat", knowledgeService.getStats(columnCategory, rowCategory,startTime,endTime,status));
	...
	public String knowledgeCount(Model model,HttpServletRequest request){
		...
		model.addAttribute("stat", knowledgeService.getStats("CODE_STATUS", null,null,null,null));
	...
	public String knowledgeCategory(Model model,HttpServletRequest request){
		...
		model.addAttribute("stat", knowledgeService.getStats("CODE_STATUS", "CODE_CATEGORY",null,null,null));
	...
	public String knowledgePerformance(Model model,HttpServletRequest request){
		...
		model.addAttribute("stat", knowledgeService.getStats("DATE_MONTH", "USER_ENGINEER",startTime,endTime,PropertyFileUtil.getStringValue("syscode.knowledge.status.published")));
	...
	public String leadertask(Model model,HttpServletRequest request){
		...
		model.addAttribute("stat", leadertaskService.getStats("DATE_MONTH", "USER_ENGINEER",startTime,endTime));
	...
	public String inspection(Model model,HttpServletRequest request){
		...
		model.addAttribute("stat", inspectionService.getStats("DATE_MONTH", "USER_ENGINEER",startTime,endTime));
	...
	public String update(Model model,HttpServletRequest request){
		...
		model.addAttribute("stat", updateService.getStats("DATE_MONTH", "USER_ENGINEER",startTime,endTime));
	...
	public String secjob(Model model,HttpServletRequest request){
		...
		model.addAttribute("stat", secjobService.getStats("DATE_MONTH", "USER_ENGINEER",startTime,endTime));
