            ...
            <div class="workplace">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <c:url var="addAction" value="/account-life-cycle/save" ></c:url>
                        ...
                        <div class="block-fluid">                        
                            <div class="row-form clearfix">
                                ...
                                <div class="col-md-3"><form:select path="categoryCode" items="${types }" itemLabel="categoryName" itemValue="categoryCode" cssStyle="width:100%"></form:select></div>
                            </div>
                            <div class="row-form clearfix">
