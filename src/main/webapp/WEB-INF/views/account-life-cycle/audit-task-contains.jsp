    ...
    <div class="wrapper"> 
        ...
        <div class="content">
            ...
            <div class="breadLine">
                ...
                <ul class="breadcrumb">
                    <li><a href="javascript:void(0);">运维管理系统</a> <span class="divider">></span></li>
                    <li><a href="${contextPath}/account-life-cycle/index">台账管理</a></li>       
                </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6" >
                        	...
                        	<div class="pull-right">
                                    <p>
                                        <a class="btn btn-default confirm" href="${contextPath}/account-life-cycle/audit-task/pass?ciid=${ci.id}&flag=1" role="button" >审核通过</a> 
                                        <a class="btn btn-default confirm" href="${contextPath}/account-life-cycle/audit-task/pass?ciid=${ci.id}&flag=0" role="button" >审核不通过</a>
                                    </p>
                                </div>
                        	</div>
                            ...
                            <table  class="table" id="eventTable">
                                <thead>
                                    <tr>
                                       <th width="30%"></th>
										<th width="35%">原数据</th>
										<th width="35%">修改后数据</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <c:forEach items="${mapContains }" var="map">
                                	<tr>
                                	<td>${map.key }</td>
                                	<td>${map.value[0] }</td>
                                	<td>${map.value[1] }</td>
