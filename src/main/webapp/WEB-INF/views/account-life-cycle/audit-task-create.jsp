    	...
    	var ctx = "${contextPath}";
            $(document).ready(function () {
                ...
                $("#categoryCode").change(function(){
                	if($(this).val()!='')
	                	$.ajax({
	        				url : "${contextPath }/account-life-cycle/get-html-by-code",//这个就是请求地址对应sAjaxSource
	        				data : {"code":$(this).val()},//这个是把datatable的一些基本数据传给后台,比如起始位置,每页显示的行数
	        				success : function(result) {
	        					$(".footer").before("<div class='row-form clearfix'> 	<div class='col-md-1'><label >文件:</label></div><div class='col-md-11'>	<input type='text‘ name='file_upload' /></div></div> ");
	        				},
	        				error : function(msg) {
	        				}
	        			});
                ...
                //$(".dateISO").datepicker();
                if($("#validation").find('.dateISO').length>0) {
            		$('.dateISO').datepicker();
            	}
        ...
        <div class="content">
            ...
            <div class="breadLine">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="${contextPath }/cms/ci/list">资产管理</a> <span class="divider">></span></li>         
                    <li class="active">新建资产</li>
                </ul>
            ...
            <div class="workplace">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <c:url var="addAction" value="/account-life-cycle/audit-task/save" ></c:url>
						<form:form id="validation"  action="${addAction}" commandName="ci" method="post">
						<form:hidden path="id"/>
						<form:hidden path="use" value="启用"/>
						<form:hidden path="departmentInUse" value="${group.id }"/>
                        ...
                        <div class="block-fluid">                        
                            <div class="row-form clearfix">
                                ...
                                <div class="col-md-3">${category.categoryName }</div>
                            </div>
                            <div class="row-form clearfix">
                            ...
                            <div class="row-form clearfix">
                                ...
                                <div class="col-md-3"><form:input path="securityNo" class="validate[required]"></form:input></div>
                                
                            </div>
                            <div class="row-form clearfix">
                                <div class="col-md-1"><form:label path="departmentInUseName">所属部门:</form:label></div>
                                <div class="col-md-3"><form:input path="departmentInUseName" class="validate[required]" type="text" value="${group.groupName }" readonly="true"/></div>
