...
<head>        
    ...
    <script type='text/javascript' src='${contextPath }/resources/js/change-handler.js'></script>
                     ...
                     <div style="text-align:right;">
                         ...
                         <div class="info">                                                                
                            ...
                            <li>
                                ...
                                <div class="text">${change.influence }</div>
                            </li> 
                            <li>
                                <div class="title">紧急性:</div>
                                <div class="text">${change.critical }</div>
                            </li>
                            <li>
                                <div class="title">优先级:</div>
                                <div class="text">${change.priority }</div>
                            </li>
                            <li>
                                <div class="title">风险程度:</div>
                                <div class="text">${change.risk }</div>
                            </li>
                            <li>
                                <div class="title">变更分类:</div>
                                <div class="text">${change.changeType }</div>
                            </li>
                            <li>
