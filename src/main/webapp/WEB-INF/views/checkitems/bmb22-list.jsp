                    ...
                    <div class="col-md-12" id="mails">
                      ...
                      <li class="dropdown">
						...
						<a href="${contextPath }/checkitems/list/items/${children1.id }">${children1.name }</a>
			                ...
			                <li <c:if test="${!empty children2.child }">class="dropdown-submenu"</c:if>>
			                <a tabindex="0" href="${contextPath }/checkitems/list/items/${children2.id}">${children2.name }</a>
			                <c:if test="${!empty children2.child }">
							<ul class="dropdown-menu" >
							<li><a href="${contextPath }/checkitems/list/items/${children2.id }">${children2.name }</a></li>
							<li class="divider"></li>
							<c:forEach items="${children2.child }" var="children3">
			                <li><a tabindex="0" href="${contextPath }/checkitems/list/items/${children3.id }">${children3.name }</a></li>
			                </c:forEach>
			                </ul>
							</c:if></li>
			                </c:forEach>
