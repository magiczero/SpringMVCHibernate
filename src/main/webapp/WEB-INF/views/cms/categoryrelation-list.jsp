                            ...
                            <table class="table" id="eventTable">
                                ...
                                <tbody>
									...
									<tr>
										...
										<td>
											<a href="${contextPath}/cms/categoryrelation/delete/${categoryRelation.id}" class="confirm"><span class="glyphicon glyphicon-remove"></span> 删除</a>
										</td>
									</tr>
								</c:forEach>   
                                </tbody>
