                                ...
                                <tbody>
                                	...
                                	<c:if test="${not empty mytasks[incident.processInstanceId] }">
	                                    ...
	                                    <tr>
	                                        ...
	                                        <td><fmt:formatDate value="${incident.applyTime }" pattern="MM-dd HH:mm" /></td>
	                                        ...
	                                        <td>
												...
												<c:if test="${not empty task.assignee }">
	                                        		<a href="${contextPath }/incident/deal/${incident.id}/${task.id}">办理</a>
	                                        	</c:if>
	                                        </td>
	                                    </tr>
                                    </c:if>
                                    <c:if test="${empty mytasks[incident.processInstanceId] }">
                                    	...
                                    	<c:set var="task" value="${tasks[incident.processInstanceId]}" />
                                    		<tr>
		                                        ...
		                                        <td>${incident.statusName }</td>
		                                        <td>
		                                        	<a href="${contextPath }/incident/view/${incident.id}">查看</a>
		                                        </td>
		                                    </tr>
                                    	</c:if>
                                    </c:if>
