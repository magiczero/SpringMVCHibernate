                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" class="table" id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><fmt:formatDate value="${incident.applyTime }" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                        <td><fmt:formatDate value="${incident.recoverTime }" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                                        <td>
                                        	<a href="${contextPath }/incident/deal/${incident.id}">查看</a>
                                        </td>
                                    </tr>
                                   </c:forEach>
                                </tbody>
