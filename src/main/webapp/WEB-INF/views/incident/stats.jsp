...
<head>        
    ...
    <script type='text/javascript' src='${contextPath }/resources/js/pm-common.js'></script>
        <script type='text/javascript' src='${contextPath }/resources/js/incident-charts.js'></script>
                ...
                <div class="row">
                	<div class="col-md-3">
                            ...
                            <ul class="sList" id="selectable_1">
                                ...
                                <li>本月故障率统计</li>
                                <li>本月工作绩效统计</li>
                                <li><a href='${contextPath }/incident/mystats'>高级统计设置</a></li>
                            </ul>                                                
                        </div>
                	</div>
                    <div class="col-md-9">
                        <div class="block-fluid without-head">
                            ...
                            <form action="${contextPath }/incident/stats">
                        ...
                        <div class="block">
                            <div id="chart_incident" style="height: 310px;">
