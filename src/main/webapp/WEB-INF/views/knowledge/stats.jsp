...
<head>        
    ...
    <script type='text/javascript' src='${contextPath }/resources/js/pm-common.js'></script>
        <script type='text/javascript' src='${contextPath }/resources/js/knowledge-charts.js'></script>
                ...
                <div class="row">
                	<div class="col-md-4">
                		<div class="block-fluid without-head">
                            ...
                            <form action="${contextPath }/knowledge/stats">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="block">
                            <div id="chart_knowledge" style="height: 310px;">
