    ...
    <script type="text/javascript">
	    $(document).ready(function () {
	    	$("#createHD").click(function() {
	    		window.location.href="${contextPath }/networkcard/add/${serverid}";
	    	});
		    			...
		    			$.ajax({
		    				...
		    				success : function(data) {
		    					if (data.flag == "true") {
		    						...
		    						window.location.href="${contextPath }/networkcard/list/"+data.serverid;
                    ...
                    <div class="col-md-12" id="mails">
                        <div class="block-fluid" id="inbox">
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" class="table" id="datalist">
                               ...
                               <tbody> <c:forEach items="${listNet}" var="net">
                               	<tr>
                               		<td><input type="checkbox" name="ids" value="${net.id }"/></td>
                               		<td>${net.cardType.name }</td>
                               		<td>${net.macAdd }</td>
                               		<td>${net.internetProtocol }</td>
