...
<a class="logo" href="index.html"><img src="${contextPath }/resources/img/logo.png" alt="运维管理系统" title="运维管理系统"/></a>
    ...
    <li class="settings_icon">
        ...
        <div id="themeSettings" class="popup">
            ...
            <div class="body settings">
                <div class="row">
                    <div class="col-md-3"><strong>主题:</strong></div>
                    <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-md-3"><strong>背景:</strong></div>
                    <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-md-3"><strong>固定宽度:</strong></div>
                    <div class="col-md-9">
                        <input type="checkbox" name="settings_fixed" value="1"/>
                    </div> 
                </div>
                <div class="row">
                    <div class="col-md-3"><strong>隐藏菜单:</strong></div>
                    <div class="col-md-9">
            ...
            <div class="footer">                            
                <button class="btn btn-default link_themeSettings" type="button">关闭</button>
            </div>
        </div>                            
    </li>                
</ul>    
