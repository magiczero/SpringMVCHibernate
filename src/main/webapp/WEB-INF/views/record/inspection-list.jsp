                ...
                <div class="row">
                   <div class="col-md-3 clearfix" id="mails_navigation">                    
                        <div class="block-fluid sNavigation">
                            <ul>
                            	<li class="active"><a href="${contextPath }/record/inspection"><span class="glyphicon glyphicon-envelope"></span> 日常巡检</a><span class="arrow"></span></li>
                                ...
                                <li><a href="${contextPath }/record/training"><span class="glyphicon glyphicon-envelope"></span> 三员培训</a><span class="arrow"></span></li>
                            </ul>
                        </div>                      
                    </div>
                    <div class="col-md-9">                    
                        ...
                        <div class="block-fluid table-sorting clearfix">
                            <table class="table" id="eventTable">
                                ...
                                <tbody>
									...
									<tr>
										<td><a href="${contextPath }/record/inspection/deal/${inspection.id}">${inspection.id }</a></td>
										<td>${inspection.executionUser }</td>
										<td><fmt:formatDate value="${inspection.createdTime }" pattern="yyyy-MM-dd"></fmt:formatDate></td>
										<td><fmt:formatDate value="${inspection.executionTime }" pattern="yyyy-MM-dd"></fmt:formatDate></td>
										<td>
											<c:if test="${not empty record.processInstanceId }">
