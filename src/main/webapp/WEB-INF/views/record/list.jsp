                   ...
                   <div class="col-md-3 clearfix" id="mails_navigation">                    
                        <div class="block-fluid sNavigation">
                            <ul>
                                ...
                                <li class="active"><a href="${contextPath }/record/list"><span class="glyphicon glyphicon-inbox"></span> 病毒库升级</a><span class="arrow"></span></li>
                        ...
                        <div class="block-fluid table-sorting clearfix">
                            <table class="table" id="eventTable">
                                ...
                                <tbody>
									...
									<c:set var="pdid" value="${record.processInstanceId }" />
									<tr>
										<td>${record.id }</td>
										<td>${record.name }</td>
										<td>${record.version }</td>
										<td><fmt:formatDate value="${record.updateTime }" pattern="yyyy-MM-dd"></fmt:formatDate></td>
										<td>${record.userId }</td>
										<td>
