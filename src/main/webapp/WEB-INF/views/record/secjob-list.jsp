                        ...
                        <div class="block-fluid table-sorting clearfix">
                            <table class="table" id="myTable">
                                ...
                                <tbody>
									...
									<c:set var="pdid" value="${job.processInstanceId }" />
									<tr>
										<td>${job.typeName }</td>
										<td>${job.userName }</td>
										...
										<td>
											<c:if test="${not empty job.processInstanceId }">
												<a class="lnk_trace" href='#' pid="${job.processInstanceId }" pdid="<%=ProcessDefinitionCache.getProcessDefinitionId(pageContext.getAttribute("pdid").toString()) %>" title="点击查看流程图">
										...
										<td>
											<c:if test="${empty job.executionTime }">
												<a href="#" onclick="act_form_openTaskDialog('三员工作任务','<%=ProcessDefinitionCache.getTaskId(pageContext.getAttribute("pdid").toString()) %>','/record/secjob')">办理</a>
											</c:if>
											<c:if test="${not empty job.executionTime }">
											<a href="#" title="${job.attachment }">下载附件</a>
											</c:if>
										</td>
									</tr>
								</c:forEach>   
