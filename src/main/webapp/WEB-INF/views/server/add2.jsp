            ...
            <div class="workplace">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <c:url var="addAction" value="/Server/saves" ></c:url>
						<form:form action="${addAction}" commandName="server">
						<form:hidden path="assetNum"/>
						<form:hidden path="secretNum"/>
						<form:hidden path="equipType.id"/>
						<form:hidden path="brand"/>
						<form:hidden path="model"/>
						<form:hidden path="snNum"/>
						<form:hidden path="secretLevel"/>
						<form:hidden path="purpose"/>
						<form:hidden path="productionDate"/>
						<form:hidden path="purchaseTime"/>
                        <div class="block-fluid">                        
                          
                             <div class="row-form clearfix">
                                <div class="col-md-2"><form:label path="cpu">CPU</form:label></div>
                                <div class="col-md-4"><form:input path="cpu" /></div>
                                <div class="col-md-2"><form:label path="memory">内存</form:label></div>
                                <div class="col-md-4"><form:input path="memory" /></div>
                            </div> 
                            <div class="row-form clearfix">
                                <div class="col-md-2"><form:label path="raidCard">raid卡</form:label></div>
                                <div class="col-md-4"><form:input path="raidCard" /></div>
                                <div class="col-md-2"><form:label path="raidModel">raid模式</form:label></div>
                                <div class="col-md-4"><form:input path="raidModel" /></div>
                            </div>                                                               
  							<div class="row-form clearfix">
                                <div class="col-md-2"><form:label path="cdrom">光驱</form:label></div>
                                <div class="col-md-4"><form:input path="cdrom" /></div>
                                <div class="col-md-2"><form:label path="powerNum">电源数量</form:label></div>
                                <div class="col-md-4"><form:input path="powerNum"  value="1"/></div>
                            </div>     
