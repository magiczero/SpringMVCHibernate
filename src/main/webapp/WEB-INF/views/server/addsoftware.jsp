  	...
  	<div class="breadLine">
            ...
            <div class="workplace">          
                ...
                <div class="page-header">
                    <h1>软件 <small>安装信息</small></h1>
                </div>  
                
                <div class="row">
					<c:url var="addAction" value="/Server/savesoftware" ></c:url>
                    <form:form action="${addAction}" commandName="serverSoft">
