            ...
            <div class="workplace">
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        ...
                        <c:url var="addAction" value="/software/save" ></c:url>
                        ...
                        <div class="block-fluid">                        
                             ...
                             <div class="row-form clearfix">
                                <div class="col-md-4"><form:label path="num">软件编号*</form:label></div>
                                <div class="col-md-8"><form:input path="num" class="validate[required]"/></div>
                            </div> 
                            <div class="row-form clearfix">
                                <div class="col-md-4"><form:label path="name">软件名称*</form:label></div>
                                <div class="col-md-8"><form:input path="name" class="validate[required]"/></div>
                            </div>                                                               
  							<div class="row-form clearfix">
                                <div class="col-md-4"><form:label path="versions">版本*</form:label></div>
                                <div class="col-md-8"><form:input path="versions" class="validate[required]"/></div>
                            </div>     
							<div class="row-form clearfix">
                                <div class="col-md-4"><form:label path="remark">备注</form:label></div>
                                <div class="col-md-8"><form:input path="remark" /></div>
                            </div>  
