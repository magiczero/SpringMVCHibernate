                        ...
                        <div class="block-fluid accordion">
                            ...
                            <div>
                                 <ul>
                                 	...
                                 	<li><a href="${contextPath }/stats/change/category">变更分类统计</a></li>
                    ...
                    <div class="col-md-9">
                        <div class="block-fluid without-head">
                			<div class="toolbar nopadding-toolbar clearfix">
                            	...
                            	<form action="${contextPath }/stats/change">
	                            <div class="row-form clearfix">
	                                ...
	                                <div class="col-md-4">
	                                	<select name="columnCategory" id="columnCategory">
                                            ...
                                            <option value="CODE_RISK">风险等级</option>
                                            <option value="CODE_CHANGE_STATUS">状态</option>
	                                ...
	                                <div class="col-md-4">
	                                	<select name="rowCategory" id="rowCategory">
                                            ...
                                            <option value="CODE_RISK">风险等级</option>
                                            <option value="CODE_CHANGE_STATUS">状态</option>
                                            <option value="USER_CHANGE_ENGINEER">工程师</option> 
                                            <option value="USER_APPLY">申请用户</option> 
                                            <option value="CI_CHANGE_ASSET">资产配置项</option> 
                                            <option value="DATE_MONTH">月份</option>
                                            <option value="DATE_YEAR">年度</option>
                                    	</select>
	                                </div>
