                    ...
                    <div class="col-md-9">
                        <div class="block-fluid without-head">
                			<div class="toolbar nopadding-toolbar clearfix">
                            	...
                            	<form action="${contextPath }/stats/incident">
	                            <div class="row-form clearfix">
	                                ...
	                                <div class="col-md-4">
	                                	<select name="columnCategory" id="columnCategory">
                                            ...
                                            <option value="CODE_INCIDENT_STATUS">状态</option>
                                            <option value="CODE_SATISFACTION">满意度</option> 
                                            <option value="CODE_INCIDENT_CATEGORY">事件分类</option>
                                            <option value="CODE_SOURCE">事件来源</option>
                                            <option value="USER_INCIDENT_ENGINEER">工程师</option> 
                                            <option value="USER_APPLY">申请用户</option> 
                                            <option value="CI_INCIDENT_ASSET">资产配置项</option>
                        ...
                        <div class="block-fluid">
                            <table class="table">
                                <thead>
                                    <tr>                                    
                                        <th>统计项</th>
                                        <th width="150px" class="tac">总数</th>
