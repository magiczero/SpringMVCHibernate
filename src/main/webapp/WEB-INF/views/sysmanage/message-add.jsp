...
<head>        
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
		    ...
		    $("input[name='toUserName']").bind("click",function(){
		    	$("#grouptree").empty();
		    	$("#grouptree").treeview({
        ...
        function inputUserinfo(username,realname,tel,room,userid) {
        	$("#toUser").attr("value", username);
        	$("input[name='toUserName']").attr("value",realname);
        ...
        <div class="content">
            ...
            <div class="breadLine">
                <ul class="breadcrumb">
                    ...
                    <li><a href="${contextPath }/message/list">消息管理</a> <span class="divider">></span></li>   
                </ul>
                <ul class="buttons"></ul>
            </div>
            <!--breadline end-->
            ...
            <div class="workplace">
                ...
                <div class="row">
	                ...
	                <div class="col-md-10">
	                        ...
	                        <c:url var="addAction" value="/message/send" ></c:url>
	                        <form:form action="${addAction}" commandName="message" method="post" id="validation">
	                        <form:hidden path="toUser" />
	                        <input id="fileids" name="fileids" type="hidden" />
	                        <div class="block-fluid">                        
	                            <div class="row-form clearfix">
	                                <div class="col-md-1"><label for="toUserName">发送给:</label></div>
	                                <div class="col-md-11"><input type="text" name="toUserName" class="validate[required]" /></div>
	                             </div>
	                            <div class="row-form clearfix">
	                                <div class="col-md-1"><form:label path="content">内容:</form:label></div>
	                                <div class="col-md-11"><form:textarea path="content" class="validate[required,maxSize[255]]"></form:textarea>
	                                </div>
	                            </div>
                                <div class="row-form clearfix">
