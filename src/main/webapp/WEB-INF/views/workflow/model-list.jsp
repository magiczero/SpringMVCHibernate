                            ...
                            <table class="table" id="eventTable">
                                ...
                                <c:forEach items="${list }" var="model">
									<tr>
										...
										<td>
											<a href="${contextPath}/service/editor?id=${model.id}" target="_blank">编辑</a>
											<a class="confirm" href="${contextPath}/workflow/model/deploy/${model.id}">部署</a>
											<a class="confirm" href="${contextPath}/workflow/model/export/${model.id}" target="_blank">导出</a>
					                        <a class="confirm" href="${contextPath}/workflow/model/delete/${model.id}">删除</a>
										</td>
									</tr>
								</c:forEach>   
                                </tbody>
